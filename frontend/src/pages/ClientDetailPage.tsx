...
import type { Address, ApplicationSettings, Client, Service, Technician } from "../types";
...
export function ClientDetailPage({ technician = false }: { technician?: boolean }) {
  ...
  return <div className="page">
    ...
    {selectedService && <ServicePanel serviceId={selectedService} onClose={() => setSelectedService(null)} allowFinance={!technician} />}
  </div>;
}
